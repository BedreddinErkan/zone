...
exports.validatePatchScope = validatePatchScope;
const SCOPE_LIMITS = {
...
function validatePatchScope(intentType, totalChangedLines, changedFileCount) {
    ...
    const confidencePenalty = Math.min(rawPenalty, 40);
    // Scope rating
    let scopeRating;
    if (hardCount >= 2) {
...
//# sourceMappingURL=patchScopeValidator.js.map