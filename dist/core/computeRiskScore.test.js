...
(0, vitest_1.describe)("computeRiskScore", () => {
    ...
    (0, vitest_1.it)("returns high score for destructive database work", () => {
    ...
    (0, vitest_1.it)("returns mass_scope signal for 'delete all users'", () => {
        ...
        (0, vitest_1.expect)(result.breakdown.massScope).toBe(25);
    });
    (0, vitest_1.it)("returns mass_scope signal for 'truncate sessions'", () => {
    ...
    (0, vitest_1.it)("stacks destructive + mass_scope for 'delete all user sessions' → score 75", () => {
