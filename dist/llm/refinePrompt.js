...
exports.PROMPT_REFINEMENT_FALLBACK = void 0;
exports.refinePrompt = refinePrompt;
const openaiClient_js_1 = require("./openaiClient.js");
exports.PROMPT_REFINEMENT_FALLBACK = "Describe the exact file, function, and behavior you want changed.";
function cleanRefinedPrompt(value) {
...
`.trim();
    ...
    return refined || exports.PROMPT_REFINEMENT_FALLBACK;
}
