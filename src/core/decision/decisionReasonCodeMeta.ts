...
export type DecisionReasonSeverity = "low" | "medium" | "high";

export type DecisionReasonCodeMeta = {
...
export const DECISION_REASON_CODE_META: Record<
  DecisionReasonCode,
  DecisionReasonCodeMeta
> = {
  BLOCKED_DESTRUCTIVE_OPERATION: {
    code: "BLOCKED_DESTRUCTIVE_OPERATION",
    label: "Destructive operation detected",
    summary:
      "Task includes destructive intent and should not be auto-applied.",
    severity: "high",
    category: "safety"
  },
  BLOCKED_SCHEMA_RISK: {
    ...
    summary:
      "Task touches schema-sensitive areas and may break existing contracts.",
    severity: "high",
    category: "risk"
  },
  BLOCKED_CRITICAL_RISK: {
    ...
    summary:
      "Task affects a critical domain and requires manual review before apply.",
    severity: "high",
    category: "risk"
  },
  BLOCKED_HIGH_RISK_SCORE: {
    ...
    summary:
      "Overall risk score exceeded the blocked threshold for auto-apply.",
    severity: "high",
    category: "risk"
  },
  PREVIEW_DESTRUCTIVE_SIGNAL: {
    ...
    summary:
      "Task contains destructive indicators and should be previewed carefully.",
    severity: "high",
    category: "safety"
  },
  PREVIEW_SCHEMA_UNCERTAINTY: {
    ...
    summary:
      "Task appears schema-related and should be verified before applying.",
    severity: "medium",
    category: "risk"
  },
  PREVIEW_CRITICAL_SIGNAL: {
    ...
    summary:
      "Task touches a critical area and should remain in preview mode.",
    severity: "medium",
    category: "risk"
  },
  PREVIEW_MASS_SCOPE_CHANGE: {
    ...
    summary:
      "Task appears to affect many records or a broad surface area.",
    severity: "high",
    category: "scope"
  },
  PREVIEW_LOW_CONFIDENCE: {
    ...
    summary:
      "Confidence score is below the safe threshold, so preview is safer.",
    severity: "medium",
    category: "confidence"
  },
  SAFE_LOW_RISK_LOCALIZED: {
    ...
    summary:
      "Task appears narrowly scoped and low risk for automatic application.",
    severity: "low",
    category: "safety"
  },
  SAFE_HIGH_CONFIDENCE: {
    ...
    summary:
      "Confidence score is strong enough to support safe auto-apply.",
    severity: "low",
    category: "confidence"
  }
};

export function getDecisionReasonCodeMeta(
  code: DecisionReasonCode
): DecisionReasonCodeMeta {
  return DECISION_REASON_CODE_META[code];
}

export function buildDecisionReasonDetails(
